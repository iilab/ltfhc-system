...
__attribute__((section("__versions"))) = {
	...
	{ 0x2eaea38c, "usbnet_tx_timeout" },
	{ 0x1e9f20e8, "usbnet_change_mtu" },
	{ 0xd44e9ac4, "eth_validate_addr" },
	{ 0x81182767, "usbnet_start_xmit" },
	{ 0xac65d44, "usbnet_stop" },
	{ 0xac76366b, "usbnet_open" },
	{ 0xe7c2f14a, "usbnet_disconnect" },
	{ 0x754c57a0, "usb_deregister" },
	{ 0x84e528ea, "usb_register_driver" },
	{ 0x558667ba, "usbnet_suspend" },
	{ 0x79aa04a2, "get_random_bytes" },
	{ 0x6efc9875, "usb_driver_release_interface" },
	{ 0xb3be75f6, "dev_set_drvdata" },
	{ 0xfee0571a, "dev_err" },
	{ 0xf2f1926b, "usb_cdc_wdm_register" },
	{ 0x79f8d99f, "usbnet_get_endpoints" },
	{ 0xd498a420, "usb_driver_claim_interface" },
	{ 0x7ca8858, "usbnet_get_ethernet_addr" },
	{ 0xdd703cff, "usb_ifnum_to_if" },
	{ 0x93df4fcf, "usb_autopm_put_interface" },
	{ 0xd3f5cbaf, "usb_autopm_get_interface" },
	{ 0x67e239b7, "usbnet_probe" },
	{ 0x7b8f78de, "usbnet_resume" },
...
MODULE_ALIAS("usb:v1410pA023d*dc*dsc*dp*ic*isc*ip*in00*");
MODULE_ALIAS("usb:v1410pA023d*dc*dsc*dp*ic*isc*ip*in04*");

MODULE_INFO(srcversion, "1D1C17AE2850CB8EFB8D23C");
